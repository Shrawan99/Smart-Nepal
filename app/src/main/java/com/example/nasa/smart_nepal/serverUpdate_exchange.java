 ...
 * Created NASA.
 */
public class serverUpdate_exchange extends Activity {
...
//    static int flag1=0;
    ...
    private class MyTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            prog = new ProgressDialog(serverUpdate_exchange.this);
            prog.setMessage("Connecting to Server of Ultimate Way for Exchange rates....");
            prog.show();
        }
        @Override
