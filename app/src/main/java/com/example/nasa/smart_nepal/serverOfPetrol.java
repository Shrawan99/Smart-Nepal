...
/**
 * Created by NASA on 7/3/2015.
 */
public class serverOfPetrol extends Activity {
...
//    static int flag1=0;
    ...
    private class MyTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            prog = new ProgressDialog(serverOfPetrol.this);
            prog.setMessage("Connecting to Server of Ultimate Way for Petroleum rates....");
            prog.show();
        }
        @Override
...
//                    editor.putString("EXCHANGERATESPRICE"+String.valueOf(k),tarrays2[2].toString());
    ...
    public void update_petrol() {
        new MyTask().execute(url3);
    }
